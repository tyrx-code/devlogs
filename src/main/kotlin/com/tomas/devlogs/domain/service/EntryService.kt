...
@Transactional
@Service
class EntryService (private val entryRepository: EntryRepository, private val tagRepository: TagRepository) {
    ...
    fun findById(id: UUID): Entry {
        return entryRepository.findById(id).orElseThrow { ResourceNotFoundException("Entry not found with id: $id") }
    }
